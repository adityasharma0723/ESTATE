...
const AgentDashboard = () => {
    ...
    const cards = [
        { icon: HiCollection, label: 'My Listings', value: stats.listings, to: '/agent/listings', color: 'bg-primary' },
        { icon: HiEye, label: 'Total Views', value: stats.totalViews, to: '/agent/analytics', color: 'bg-secondary' },
        { icon: HiClipboardList, label: 'Inquiries', value: stats.inquiries, to: '/agent/analytics', color: 'bg-primary-dark' },
        { icon: HiPlus, label: 'Add Property', value: '+', to: '/agent/add-property', color: 'bg-error' },
    ];

    return (
        <div>
            <div className="mb-8">
                <h1 className="font-serif text-2xl font-bold text-gray-900 dark:text-white">Agent Dashboard</h1>
